  ...
  return (
    <div class="bg-bgFooterColor p-9 rounded-3xl flex flex-col md:flex-row  gap-4 justify-between max-w-screen-lg md:mx-auto mt-48 mx-4">
      <div class="flex flex-col  md:flex-row  gap-4">
        ...
        <div>
          <h5 class="font-offbit text-xl">
            Having issues with shundo? Have a feature suggestion? wanna help
            out?{" "}
          </h5>
          <p class="text-gray-400 font-medium">
            Come join our discord server and let us know!{" "}
          </p>
        </div>
      </div>
      <div>
        <a
          ...
          target="_blank"
          class={stlyes.discordInviteButton}
        >
          Join our server
        </a>
      </div>
